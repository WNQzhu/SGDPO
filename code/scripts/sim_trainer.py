...
from sim_config import SimConfig, FDivergenceConstants, FDivergenceType
...
class SimTrainer(Trainer):
    ...
    def simpo_loss(
        ...
        logits = pi_logratios - self.args.gamma_beta_ratio
        ...
        chosen_rewards = self.beta * chosen_logps.to(self.accelerator.device).detach()
        rejected_rewards = self.beta * rejected_logps.to(self.accelerator.device).detach()
