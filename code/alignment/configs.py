...
@dataclass
class DiskDataArguments(DataArguments):
    """
    Arguments pertaining to what data we are going to input our model for training and eval.
    """
    file_type: Optional[str] = field(
        default="parquet",
        metadata={"help": "Path of the dataset."},
    )    
    path: Optional[str] = field(
        default="text",
        metadata={"help": "Path of the dataset."},
    )
    disk_mixer: Optional[Dict[str, float]] = field(
        default=None,
        metadata={"help": ("Datasets splits to be used for training ift/rl.")},
    )
